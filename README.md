...
| **Backend architecture** | Next.js as BFF | Standalone backend (e.g. Nest.js) alongside Next.js; distributed system with event-driven communication between services |
...
| **Payments** | Mock checkout (payments not required per brief) | [Paddle](https://www.paddle.com/) over Stripe — acts as merchant of record out of the box; slightly higher fees but less operational overhead |
